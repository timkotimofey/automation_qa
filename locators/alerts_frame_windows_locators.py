...
class ModalDialogsPageLocators:
    SMALL_MODAL_FRAME = (By.CSS_SELECTOR, "div[class='modal-body']")
    ...
    SMALL_CLOSE_BY_CROSS_MODAL = (By.CSS_SELECTOR, "button[class='close']")
    ...
    LARGE_CLOSE_BY_CROSS_MODAL = (By.CSS_SELECTOR, "button[class='close']")
