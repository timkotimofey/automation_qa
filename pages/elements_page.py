...
class CheckBoxPage(BasePage):  # наследуемся от BasePage
...
class WebTablePage(BasePage):
    ...
    def add_new_person(self):
        count = 1
        while count != 0:
            person_info = next(generated_person())  # for one iteration
            ...
            # next push the button "add" and fill all fields
    ...
    def update_person_info(self):  # i will update only age
        person_info = next(generated_person())
        age = person_info.age
        # next click on the pencil in website for update
...
class ButtonsPage(BasePage):
    ...
    def click_on_defferent_button(self, type_click):
        ...
        # and after it I click it all, I have to retrieve the result as a text above the buttons
...
class UploadAndDownloadPage(BasePage):
    ...
    def upload_file(self):
        ...
        os.remove(path)  # delete created .txt file
    ...
    def download_file(self):
        ...
        path_name_file = rf'D:\PythonHarper\filetest{random.randint(0, 999)}.jpg'
...
class DynamicPropertiesPage(BasePage):
    ...
    def check_changed_of_color(self):
        color_button = self.element_is_present(self.locators.COLOR_CHANGE_BUTTON)        # -is present- поскольку мне нет необходимости на него смотреть
